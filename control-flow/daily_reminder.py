...
match priority:
    ...
    case "medium":
        print(f"Note: '{task}' is a medium priority task. Consider completing it soon.") 
    case "low":
        print(f"Note: '{task}' is a low priority task. Consider completing it when you have free time.")
    case _:
        print(f"Invalid priority level: '{priority}'. Please use high/medium/low.")
if time_bound == "yes":
    print(f"Reminder: '{task}' is time-bound. Consider completing it while you still have time.")
elif time_bound !="no":
